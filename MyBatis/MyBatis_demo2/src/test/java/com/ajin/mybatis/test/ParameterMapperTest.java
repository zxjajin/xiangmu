...
import com.ajin.mybatis.mapper.ParameterMapper;
...
public class ParameterMapperTest {
     ...
     * 2.mapper接口方法的参数为多个时
     * 此时MyBatis会将这些参数放在一个map集合中，以两种方法进行存储
     * a>以arg0，arg1...为建，以参数为值
     * b>param1，param2...为键，以参数为值
     * 因此只需要通过#{}和${}以键的方式访问值即可，但是需要注意${}的单引号问题
     * 3.若mapper接口方法的参数有多个时，可以手动将这些参数放在一个map中存储
     * 只需要通过#{}和${}以键的方式访问即可，但是需要注意${}的单引号问题
     * 4.mapper接口方法的参数是一个实体类类型的参数(重点)
    ...
    public void testinsertUser(){
        SqlSession sqlSession = SqlSessionUtils.getSqlSession();
        ParameterMapper mapper = sqlSession.getMapper(ParameterMapper.class);
        int i = mapper.insertUser(new User(null, "李四", "123456", 18, "男", "1243@qq.com"));
